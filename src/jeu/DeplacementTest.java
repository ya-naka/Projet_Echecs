...
class DeplacementTest {
	...
	@Test void estDepalcementValideTest() {
		...
		assertTrue(new Deplacement(plateau, 0, 1).estDeplacementValide());
		assertTrue(new Deplacement(plateau, 0, 8).estDeplacementValide());
		assertTrue(new Deplacement(plateau, 0, 9).estDeplacementValide());
		//le roi se déplace sur une case non adjacente
		assertFalse(new Deplacement(plateau, 0, 7).estDeplacementValide());
		assertFalse(new Deplacement(plateau, 0, 15).estDeplacementValide());
		assertFalse(new Deplacement(plateau, 0, 60).estDeplacementValide());
		...
		assertFalse(new Deplacement(plateau, 0, 1).estDeplacementValide());
		assertFalse(new Deplacement(plateau, 0, 5).estDeplacementValide());
		
		//ajout d'une tour blanche en case 24 (même colonne que le roi noir)
		pieces.add(new Tour(24, blanc));
		plateau.initFixe(pieces);
		assertTrue(new Deplacement(plateau, 0, 9).estDeplacementValide());
		assertFalse(new Deplacement(plateau, 0, 8).estDeplacementValide());
		assertFalse(new Deplacement(plateau, 0, 1).estDeplacementValide());
		...
		assertTrue(new Deplacement(plateau, 0, 9).estDeplacementValide());
		assertTrue(new Deplacement(plateau, 0, 1).estDeplacementValide());
		assertTrue(new Deplacement(plateau, 8, 16).estDeplacementValide());
		assertTrue(new Deplacement(plateau, 8, 24).estDeplacementValide());
		assertFalse(new Deplacement(plateau, 8, 0).estDeplacementValide());
		assertFalse(new Deplacement(plateau, 8, 9).estDeplacementValide());
	}
